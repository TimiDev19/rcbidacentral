    ...
    <div>
        ...
        <div className=" h-fit w-full flex items-center justify-center">
          <FadeInFromBottom>
            <div className=" text-center">
              <h1 className=" text-white font-thin text-3xl md:text-5xl gothica1">Welcome To</h1>
              <h1 className=" text-white mb-4 font-semibold text-4xl md:text-6xl tracking-[0.1em] lato">ROTARY CLUB OF BIDA CENTRAL</h1>
        ...
        <div className=" h-full w-full">
          <FadeInFromRight>
            <div className="bgAbout h-full w-full rounded-lg flex items-center justify-center text-center px-2">
              <div>
                <h1 className=" text-white text-3xl md:text-5xl font-semibold lato">LEARN MORE ABOUT ROTARY</h1>
                <p className=" text-white mb-4 lato">Take a good look at some basic things about Rotary</p>
      ...
      <div className=" bgCatalogue h-[50vh] flex items-center md:justify-end justify-center px-4">
        <div className=" md:w-[50%]">
          <FadeInFromLeft>
            <h1 className=" text-white font-semibold text-3xl md:text-5xl nunito">Our Showcase</h1>
            <p className=" text-white mb-4 lato tracking-[0.1em]">View a showcase of prestigeous projects View a catalogue of prestigeous projects View a catalogue of prestigeous projects View a catalogue of prestigeous projects View a catalogue of prestigeous projects View a catalogue of prestigeous projects View a catalogue of prestigeous projects View a catalogue of prestigeous projects View a catalogue of prestigeous projects</p>
            <Link to='' className=" text-white p-2 border-white bg-opacity-10 backdrop-blur-md bg-slate-50 border-2 duration-700 hover:bg-white hover:text-black">Showcase</Link>
          </FadeInFromLeft>
        </div>
      </div>
